...
from scalarizr.externals.chef.auth import sign_request
from scalarizr.externals.chef.exceptions import ChefServerError
from scalarizr.externals.chef.rsa import Key
from scalarizr.externals.chef.utils import json
from scalarizr.externals.chef.utils.file import walk_backwards
...
def autoconfigure(base_path=None):
    ...
    The lookup order mirrors the one from scalarizr.externals.chef, first all folders from the base
